...
<!DOCTYPE html>
<html lang="en">
<title>Sulabh datta portfolio</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-white w3-animate-left w3-text-grey w3-collapse w3-top w3-center" style="z-index:3;width:300px;font-weight:bold" id="mySidebar"><br>
  <h3 class="w3-padding-64 w3-center"><b>SULABH<br>DATTA</b></h3>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row">
    <div class="w3-third">
      <img src="images/img9.jpg" style="width:100%" onclick="onClick(this)" alt="A boy surrounded by beautiful nature">
      <img src="images/img8.jpg" style="width:100%" onclick="onClick(this)" alt="What a beautiful scenery this sunset">
    </div>

    <div class="w3-third">
      <img src="images/img7.jpg" style="width:100%" onclick="onClick(this)" alt="Quiet day at the beach. Cold, but beautiful">
      <img src="images/img6.jpg" style="width:100%" onclick="onClick(this)" alt="Waiting for the bus in the desert">
    </div>
    
    <div class="w3-third">
      <img src="images/img4.jpg" style="width:100%" onclick="onClick(this)" alt="Canoeing again">
      <img src="images/img3.jpg" style="width:100%" onclick="onClick(this)" alt="A girl, and a train passing">
    </div>
  </div>
  ...
  <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
    <h4><b>About Me</b></h4>
    <img src="images/img10.jpg" alt="Me" class="w3-image w3-padding-32" width="250" height="250">
    <div class="w3-content w3-justify" style="max-width:600px">
      <h4>Sulabh Datta</h4>
      <p>Some text about me. I love taking photos of Nature. I am entheusatic about web developing.I like to work as Freelancer. 
      </p>
      <p>mail:sulabhdatta1007@gmail.com</p>
      <p>Mobile number - 8800474363</p>
      <hr class="w3-opacity">
      ...
      <h4 class="w3-padding-16"> Knowledge</h4>
  ...
  <footer class="w3-container w3-padding-32 w3-grey">  
    <div class="w3-row-padding">
      <div class="w3-third">
        <h3>Quick Contact</h3>
        <p> Mobile number - 8076278292 </p>
        <p> Gmail - sddatta12345@gmail.com  </p>
      </div>
      ...
      <div class="w3-third">
        ...
        <ul class="w3-ul">
          <li class="w3-padding-16 w3-hover-black">
              ...
              <i class="fa fa-facebook-official"></i>      <span class="w3-large"> <a href="" style="text-decoration:none"> FACEBOOK </a> </span><br>
           
          </li>
          <li class="w3-padding-16 w3-hover-black">
              <i class="fa fa-instagram"></i>  
              <span class="w3-large"> <a href="" style="text-decoration:none"> Instagram </a> </span><br>
          </li> 
        </ul>
      </div>
  ...
  <div class="w3-black w3-center w3-padding-24"> Powered by <a href="" title="W3.CSS" target="_blank" class="w3-hover-opacity">SULABH DATTA</a></div>
